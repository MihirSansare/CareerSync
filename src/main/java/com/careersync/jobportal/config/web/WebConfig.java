package com.careersync.jobportal.config.web;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configureApiVersioning(ApiVersionConfigurer configurer) {
        configurer.useMediaTypeParameter(MediaType.parseMediaType("application/vnd.careersync+json"),"v").addSupportedVersions("1.0","2.0","3.0").setDefaultVersion("1.0");
    }
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("http://localhost:5173").allowedMethods("*").allowedHeaders("*").exposedHeaders("*").allowCredentials(true).maxAge(3600);
    }
}
